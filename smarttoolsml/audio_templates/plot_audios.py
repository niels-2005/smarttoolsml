...
def plot_samples(audio_files: list, plot_audio_file: bool = True, plot_trimmed: bool = True, plot_zoomed: bool = True, plot_spectogram: bool = True, plot_mel_spectogram: bool = True):
    """_summary_
