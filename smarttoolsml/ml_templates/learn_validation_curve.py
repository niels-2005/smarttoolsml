...
def plot_validation_curve(X, y):
    ...
    plt.plot(param_range, test_mean, color='orange', marker='s', markersize=5, label='Validation Accuracy')
...
def plot_learning_curve(X, y):
    ...
    plt.plot(train_sizes_abs, test_mean, color='orange', marker='s', markersize=5, label='Validation Accuracy')
