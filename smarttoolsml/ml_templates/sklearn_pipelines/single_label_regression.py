...
pipelines = [
    Pipeline([("scaler", StandardScaler()), ("reg", LinearRegression(n_jobs=-1))]),
    Pipeline([("scaler", MinMaxScaler()), ("reg", LinearRegression(n_jobs=-1))]),
    Pipeline([("scaler", RobustScaler()), ("reg", LinearRegression(n_jobs=-1))]),
    ...
    Pipeline([("scaler", StandardScaler()), ("reg", ExtraTreesRegressor(n_jobs=-1))]),
    Pipeline([("scaler", MinMaxScaler()), ("reg", ExtraTreesRegressor(n_jobs=-1))]),
    Pipeline([("scaler", RobustScaler()), ("reg", ExtraTreesRegressor(n_jobs=-1))]),
