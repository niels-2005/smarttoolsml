...
def predictions_with_webcam(
    model: tf.keras.Model, classes: list, img_size: tuple[int, int] = (64, 64)
):
    """_summary_
    ...
    while True:
        ...
        resized_frame = cv2.resize(
            frame, img_size
        )  # Angenommen, Ihr Modell erwartet 64x64 Bilder
        ...
        cv2.putText(
            frame,
            f"Klasse: {pred_class}, Konfidenz: {confidence:.2f}",
            (10, 30),
